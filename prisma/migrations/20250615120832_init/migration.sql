...
CREATE TABLE `ProductOnOrder` (
    ...
    INDEX `ProductOnOrder_orderId_fkey`(`orderId`),
    INDEX `ProductOnOrder_productId_fkey`(`productId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `ProductOnCart` (
    ...
    INDEX `ProductOnCart_cartId_fkey`(`cartId`),
    INDEX `ProductOnCart_productId_fkey`(`productId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
